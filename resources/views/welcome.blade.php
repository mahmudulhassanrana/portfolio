...
<!-- Mirrored from baha.malyarchuk.space/ind-particles.html by HTTrack Website Copier/3.x [XR&CO 2014], Fri, 04 Mar 2022 19:44:35 GMT -->
<head>
    ...
    <!-- Title -->
    <title>MD.Mahmudul Hassan</title>
    <link rel="icon" type="image/png" href="img/utl_logo.JPG">
...
{{--        <span><svg xmlns="http://www.w3.org/2000/svg" width="28px" height="28px" viewBox="0 0 24 24"><g stroke="none"--}}
{{--                                                                                                        stroke-width="1"--}}
{{--                                                                                                        fill="none"--}}
...
{{--                        LTR </a>--}}
{{--                </li>--}}
{{--                <li><a href="rtl/ind-rtl-particles.html">--}}
{{--                        <svg xmlns="http://www.w3.org/2000/svg" width="22px" height="22px" viewBox="0 0 24 24">--}}
{{--                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">--}}
{{--                                <rect x="0" y="0" width="24" height="24"/>--}}
{{--                                <path--}}
...
{{--            <ul>--}}
{{--                <li><a href="css/settings/top-nav.css">--}}
{{--                        <svg xmlns="http://www.w3.org/2000/svg" width="22px" height="22px" viewBox="0 0 24 24">--}}
{{--                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">--}}
{{--                                <rect x="0" y="0" width="24" height="24"/>--}}
...
{{--                        </svg>--}}
{{--                        Top</a></li>--}}
{{--                <li><a href="css/settings/left-nav.css">--}}
{{--                        <svg xmlns="http://www.w3.org/2000/svg" width="22px" height="22px" viewBox="0 0 24 24">--}}
{{--                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">--}}
{{--                                <rect x="0" y="0" width="24" height="24"/>--}}
...
{{--                        </svg>--}}
{{--                        Left</a></li>--}}
{{--                <li><a href="css/settings/right-nav.css">--}}
{{--                        <svg xmlns="http://www.w3.org/2000/svg" width="22px" height="22px" viewBox="0 0 24 24">--}}
{{--                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">--}}
{{--                                <rect x="0" y="0" width="24" height="24"/>--}}
...
{{--                        </svg>--}}
{{--                        Right</a></li>--}}
{{--                <li><a href="css/settings/bottom-nav.css">--}}
...
{{--            <ul>--}}
{{--                <li><a href="css/settings/box/box.css">--}}
{{--                        <svg xmlns="http://www.w3.org/2000/svg" width="22px" height="22px" viewBox="0 0 24 24">--}}
{{--                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">--}}
{{--                                <rect x="0" y="0" width="24" height="24"/>--}}
{{--                                <path--}}
...
{{--                        Box </a>--}}
{{--                </li>--}}
{{--                <li><a href="css/settings/box/no-box.css">--}}
{{--                        <svg xmlns="http://www.w3.org/2000/svg" width="22px" height="22px" viewBox="0 0 24 24">--}}
{{--                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">--}}
{{--                                <rect x="0" y="0" width="24" height="24"/>--}}
{{--                                <path--}}
...
{{--        <div class="box-title">--}}
{{--            <ul>--}}
{{--                <li><a href="css/settings/title/title.css">--}}
{{--                        <svg xmlns="http://www.w3.org/2000/svg" width="22px" height="22px" viewBox="0 0 24 24">--}}
{{--                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">--}}
...
{{--                        Title</a>--}}
{{--                </li>--}}
{{--                <li><a href="css/settings/title/no-title.css">--}}
{{--                        <svg xmlns="http://www.w3.org/2000/svg" width="22px" height="22px" viewBox="0 0 24 24">--}}
{{--                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">--}}
...
{{--        <div class="box-style">--}}
{{--            <ul>--}}
{{--                <li><a href="css/settings/box/circle.css">--}}
{{--                        <svg xmlns="http://www.w3.org/2000/svg" width="22px" height="22px" viewBox="0 0 24 24">--}}
{{--                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">--}}
{{--                                <rect x="0" y="0" width="24" height="24"/>--}}
{{--                                <path--}}
...
{{--                        Circle</a>--}}
{{--                </li>--}}
{{--                <li><a href="css/settings/box/hexagon.css">--}}
{{--                        <svg xmlns="http://www.w3.org/2000/svg" width="22px" height="22px" viewBox="0 0 24 24">--}}
{{--                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">--}}
{{--                                <rect x="0" y="0" width="24" height="24"/>--}}
{{--                                <path--}}
                    ...
                    <div id="contact">
                        ...
                        <div class="pt-home" style="background-image: url('img/home-bg.jpg')">
                            ...
                            <section>
								...
								<b class="is-visible"> Web Application Developer</b>
								<b> Web Application Designer</b>
							</span>
                                    </p>
                                </div>
                                    ...
                                    <div class="col-lg-6 col-sm-12">
                                        ...
                                        <div class="experience box-1">
                                            ...
                                            <div class="item">
                                                ...
                                                <p>Work experience is essential for getting a job. Whether it's a short
                                                    work placement or a longer internship, work experience is always
                                                    viewed favourably by employers and can help you decide your future
                                                    career.</p>
                                            </div>
                                    ...
                                    <div class="col-lg-6 col-sm-12">
                                        ...
                                        <div class="experience box-2">
                                            ...
                                            <div class="item">
                                                <div class="main">
                                                    <h4>Phd</h4>
                                                    <p><i class="far fa-calendar-alt"></i>2011 - 2013 | Computer Science
                                                    </p>
                                                </div>
                                                <p>Work experience is essential for getting a job. Whether it's a short
                                                    work placement or a longer internship, work experience is always
                                            ...
                                            <div class="item">
                                                <div class="main">
                                                    ...
                                                    <p><i class="far fa-calendar-alt"></i>2013 - 2016 | Computer Science
                                                    </p>
                                                </div>
                                                <p>Work experience is essential for getting a job. Whether it's a short
                                                    work placement or a longer internship, work experience is always
                                            ...
                                            <div class="item">
                                                <div class="main">
                                                    <h4>Gradution</h4>
                                                    <p><i class="far fa-calendar-alt"></i>2016 - 2018 | Computer Science
                                                    </p>
                                                </div>
                                                <p>Work experience is essential for getting a job. Whether it's a short
                                                    work placement or a longer internship, work experience is always
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-sm-6">
                                            <div class="row">
                                                ...
                                                <!-- Skill Item -->
                                                <div class="col-lg-6 col-sm-6">
                                                    <div class="chart" data-percent="80" data-bar-color="#fff"> 80% <p>
                                                            PHP</p></div>
                                                </div>

                                                <!-- Skill Item -->
                                                <div class="col-lg-6 col-sm-6">
                                                    <div class="chart" data-percent="70" data-bar-color="#fff"> 70% <p>
                                                            Illustrator</p></div>
                                                </div>

                                                <!-- Skill Item -->
                                                <div class="col-lg-6 col-sm-6">
                                                    <div class="chart" data-percent="60" data-bar-color="#fff"> 60% <p>
                                                            Photoshop</p></div>
                                                </div>

                                                <!-- Skill Item -->
                                                <div class="col-lg-6 col-sm-6">
                                                    <div class="chart" data-percent="90" data-bar-color="#fff"> 90% <p>
                                                            AngularJS</p></div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-sm-12 ltr">
                                            ...
                                            <div class="single-wp width-sm process-1">
                                                ...
                                                <p>I could describe these conceptions, also impress upon paper all that
                                                    is living.</p>
                                            </div>
...
<!-- Mirrored from baha.malyarchuk.space/ind-particles.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 04 Mar 2022 19:46:20 GMT -->
</html>
